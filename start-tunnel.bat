@echo off
title Carterinha - Modo Tunnel (Expo Go)
echo ========================================================
echo   A Iniciar Carterinha em modo Tunnel (Expo Go Remoto)
echo ========================================================
echo.
...
echo [2/2] A iniciar o Expo em modo Tunnel...
cd mobile
call npx.cmd expo start --tunnel -c
